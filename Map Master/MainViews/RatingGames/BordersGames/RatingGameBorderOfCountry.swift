//
//  RatingGameBorderOfCountry.swift
//  Map Master
//
...
struct RatingGameBorderOfCountry: View {
...
struct RatingGameBorderOfCountry_Previews: PreviewProvider {
    static var previews: some View {
        RatingGameBorderOfCountry(GlobalUserData: userData())
    }
}
