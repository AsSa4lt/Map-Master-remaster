...
struct RatingGameFlagOfCountry: View {
...
struct RatingGameFlagOfCountry_Previews: PreviewProvider {
    static var previews: some View {
        RatingGameFlagOfCountry(GlobalUserData: userData())
    }
}
