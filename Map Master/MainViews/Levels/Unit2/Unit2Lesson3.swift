                        ...
                        ForEach(0..<level3unit2[0].count, id: \.self){ i in
                            Button{
                                ...
                                if show_answers == false{
                                    Image("\(level3unit2[current][i])").resizable().frame(width: UIScreen.main.bounds.width*0.4, height: UIScreen.main.bounds.width*0.25).cornerRadius(10).overlay(RoundedRectangle(cornerRadius: 10).stroke(Color.orange, lineWidth: 4)).shadow(radius: 2).padding(.bottom)
                                }else{
                                    if answer32unit2[current] == i{
                                        Color.green.overlay(
