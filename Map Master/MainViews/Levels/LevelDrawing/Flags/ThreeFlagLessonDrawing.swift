...
struct ThreeFlagLessonDrawing: View {
            ...
            VStack{
                if current < 10{
                    VStack{
                        ...
                        ThreeFlagsButton(isTapped: $isTapped, GlobalUserData: GlobalUserData, current: $current, answer: $answer, correct: $correct, show_answers: $show_answers, answers: answers, level: level, what_to_change: $unit_bool_change, unit_change: $unit_change)
                    }.padding()
