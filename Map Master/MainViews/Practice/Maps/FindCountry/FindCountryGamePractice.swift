            ...
            VStack{
                ...
                if before_game <= 0{
                    if timeLeft > 0{
                        ...
                        if score > GlobalUserData.result_find_countries[choice-1]{
                            GlobalUserData.result_find_countries[choice-1] = score
                        }
                    }
                }
            }
...
struct FindCountryGamePractice_Previews: PreviewProvider {
    static var previews: some View {
        FindCountryGamePractice(GlobalUserData: userData(), choice: Int())
    }
}
