    ...
    var body: some View {
        ZStack{
            ...
            Group{
                ...
                Image("\(name)").resizable().frame(width: size_ball, height: size_ball).clipShape(Circle()).overlay(Circle().stroke(Color.orange, lineWidth: 1)).shadow(radius: 2).padding(.bottom)
                if hat != ""{
